...
RAW_TABLE_SCHEMAS: dict[str, str] = {
    "olist_customers_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_customers_dataset (
    ...
    "olist_orders_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_orders_dataset (
    ...
    "olist_order_items_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_order_items_dataset (
    ...
    "olist_order_payments_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_order_payments_dataset (
    ...
    "olist_order_reviews_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_order_reviews_dataset (
    ...
    "olist_sellers_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_sellers_dataset (
    ...
    "olist_products_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_products_dataset (
            ...
            PRODUCT_WEIGHT_G                VARCHAR     NOT NULL,
            PRODUCT_LENGTH_CM               VARCHAR     NOT NULL,
            PRODUCT_HEIGHT_CM               VARCHAR     NOT NULL,
            PRODUCT_WIDTH_CM                VARCHAR     NOT NULL
        )
    """,
    "product_category_name_translation.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.product_category_name_translation (
            PRODUCT_CATEGORY_NAME           VARCHAR     NOT NULL,
            PRODUCT_CATEGORY_NAME_ENGLISH   VARCHAR     NOT NULL
        )
    """,
    "olist_geolocation_dataset.csv": """
        CREATE TABLE IF NOT EXISTS {database_name}.RAW.olist_geolocation_dataset (
