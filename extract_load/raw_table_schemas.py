...
RAW_TABLE_SCHEMAS: dict[str, str] = {
    "olist_customers_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_customers_dataset (
    ...
    "olist_orders_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_orders_dataset (
    ...
    "olist_order_items_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_order_items_dataset (
    ...
    "olist_order_payments_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_order_payments_dataset (
    ...
    "olist_order_reviews_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_order_reviews_dataset (
    ...
    "olist_sellers_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_sellers_dataset (
    ...
    "olist_products_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_products_dataset (
    ...
    "olist_geolocation_dataset.csv": """
        CREATE TABLE IF NOT EXISTS OLIST_DB.RAW.olist_geolocation_dataset (
